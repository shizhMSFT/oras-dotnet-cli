...
Invoke-WebRequest -Uri "https://github.com/shizhMSFT/oras-dotnet-cli/releases/download/v0.1.2/oras-win-x64.zip" -OutFile "oras-win-x64.zip"
...
```powershell
Invoke-WebRequest -Uri "https://github.com/shizhMSFT/oras-dotnet-cli/releases/download/v0.1.2/oras-win-arm64.zip" -OutFile "oras-win-arm64.zip"
...
```bash
# Download and extract
curl -LO https://github.com/shizhMSFT/oras-dotnet-cli/releases/download/v0.1.2/oras-osx-arm64.tar.gz
...
```bash
curl -LO https://github.com/shizhMSFT/oras-dotnet-cli/releases/download/v0.1.2/oras-osx-x64.tar.gz
...
```bash
curl -LO https://github.com/shizhMSFT/oras-dotnet-cli/releases/download/v0.1.2/oras-linux-arm64.tar.gz
